...
This investigation found that \todo{bla bla}

This work has the following innovations: \todo{"has" wtf}
...
Additional tests beyond the original scope of the research were carried out after the initial investigation results showed that the GAN approach is viable \todo{to determine impact of variables}
