...
This section outlines the design and implementation of the actual software. The software implements the concepts from section  \ref{section:conceptual_design} and broadly follows the structure demonstrated in TensorFlow's tutorials \cite{tensorflow2018tutorials} \cite{tensorflow2018tfgan}.
...
\subsection{Training Procedure for the Discriminative GAN}\label{subsection:training_disc}
TODO: the training procedure


\subsection{Training Procedure for the Predictive GAN}\label{subsection:training_pred}
TODO: the training procedure
