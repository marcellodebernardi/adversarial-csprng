...
def save_sequence(sequence: np.ndarray):
    """Saves a sequence of values generated by the generator as a file that can
    be interpreted by the NIST test suite.
    """
    ...
    with open('../sequences/sequence.txt', 'w') as file:
